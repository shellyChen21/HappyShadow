    ...
    SubShader
    {
        ...
        Pass
        {
			...
			)
			{
				...
				float2 uv_TextureSample = texCoord0 * _TextureSample_ST.xy + _TextureSample_ST.zw;
				float4 tex2DNode9 = tex2D( _TextureSample, uv_TextureSample );
				
				float temp_output_13_0 = ( tex2DNode9.a * _Color.a );
				

				surfaceDescription.BaseColor = ( tex2DNode9 * _Color ).rgb;
				...
				surfaceDescription.NormalAlpha = 1;
					...
					surfaceDescription.MAOSAlpha = temp_output_13_0;
				#endif
        ...
        Pass
        {
			...
			)
			{
				...
				float2 uv_TextureSample = packedInput.texCoord0.xy * _TextureSample_ST.xy + _TextureSample_ST.zw;
				float4 tex2DNode9 = tex2D( _TextureSample, uv_TextureSample );
        ...
        Pass
        {
			...
			{
				float2 uv_TextureSample = packedInput.ase_texcoord.xy * _TextureSample_ST.xy + _TextureSample_ST.zw;
				float4 tex2DNode9 = tex2D( _TextureSample, uv_TextureSample );
				

				float3 BaseColor = ( tex2DNode9 * _Color ).rgb;
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;10;-246,-95.5;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;13;-246,19.5;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;12;-617,31.5;Inherit;False;Property;_Color;Color;1;0;Create;True;0;0;0;False;0;False;1,1,1,1;1,1,1,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;2;0,0;Float;False;True;-1;2;UnityEditor.Rendering.Universal.DecalShaderGraphGUI;0;14;Decal;c2a467ab6d5391a4ea692226d82ffefd;True;DecalScreenSpaceProjector;0;2;DecalScreenSpaceProjector;9;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;3;RenderPipeline=UniversalPipeline;PreviewType=Plane;ShaderGraphShader=true;True;3;True;12;all;0;True;True;2;5;False;;10;False;;0;5;False;;10;False;;False;False;False;False;False;False;False;False;False;False;False;True;True;1;False;;False;False;False;False;False;False;False;False;False;False;True;True;2;False;;True;2;False;;False;True;1;LightMode=DecalScreenSpaceProjector;False;False;0;;0;0;Standard;7;Affect BaseColor;1;0;Affect Normal;0;638561922542976844;Blend;1;0;Affect MAOS;1;638561924689686877;Affect Emission;0;0;Support LOD CrossFade;0;638561921881966936;Angle Fade;1;638561926056649682;0;9;True;False;True;True;True;False;True;True;True;False;;False;0
Node;AmplifyShaderEditor.SamplerNode;9;-712,-182.5;Inherit;True;Property;_TextureSample;Texture Sample;0;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;14;-359.1412,133.0464;Inherit;False;Property;_Metallic;Metallic;2;0;Create;True;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;15;-357.1412,216.0464;Inherit;False;Property;_Smoothness;Smoothness;3;0;Create;True;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
...
WireConnection;2;7;13;0
ASEEND*/
//CHKSM=CD91DCE454F925BB907964B3E542B6147E538251